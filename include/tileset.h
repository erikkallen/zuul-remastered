...
typedef struct Text {
  ...
  char *
      halign; // Horizontal alignment (center, right, justify or left (default))
  bool italic; // Whether to use an italic font (default: false)
  bool
      kerning; // Whether to use kerning when placing characters (default: true)
...
typedef struct Object {
  ...
  char *template; // Reference to a template file, in case object is a template
                  // instance
